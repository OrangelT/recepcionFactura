...
*OT
    DATA: BEGIN OF isearchpoints,
            dirname(120) TYPE c,            " name of directory. "(75) nvsacc
            aliass(120)  TYPE c,            " alias for directory."(75) nvsacc
            svrname(120) TYPE c,            " svr where directory is availabl"(75) nvsacc
            sp_name(120) TYPE c,            " name of entry. (may end with *)"(75) nvsacc
...
*** bom nvsacc
***Se debe comentar la creación de formulario PDF
***
