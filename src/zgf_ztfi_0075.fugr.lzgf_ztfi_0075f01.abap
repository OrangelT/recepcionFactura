...
**//.. Filtrar datos por autorizarión
  DATA: lt_ztfi_0075 TYPE TABLE OF ztfi_0075,
        ls_ztfi_0075 TYPE ztfi_0075.

  LOOP AT <primtab> INTO <vim_total_struc>.
    ls_ztfi_0075 = <vim_total_struc>.

    PERFORM fo_authority_check USING    ls_ztfi_0075-bukrs
                               CHANGING sy-subrc.
    IF sy-subrc NE 0.
      DELETE <primtab>.
    ENDIF.
...
FORM fo_new_entry.
  ...
  PERFORM fo_authority_check USING    ztfi_0075-bukrs
                             CHANGING sy-subrc.
  IF sy-subrc NE 0.
    MESSAGE e800(fr) WITH ztfi_0075-bukrs.
  ENDIF.
