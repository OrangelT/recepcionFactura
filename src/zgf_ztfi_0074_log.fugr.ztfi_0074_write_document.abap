...
* THIS FILE IS GENERATED. NEVER CHANGE IT MANUALLY, PLEASE!
  ...
  IF UPD_ZTFI_0074 NE SPACE.
    IF ( XZTFI_0074[] IS INITIAL ) AND
       ( YZTFI_0074[] IS INITIAL ).
      UPD_ZTFI_0074 = SPACE.
    ENDIF.
  ENDIF.
  ...
  IF UPD_ZTFI_0074 NE SPACE.
    CALL FUNCTION 'CHANGEDOCUMENT_MULTIPLE_CASE'
      EXPORTING
        TABLENAME              = 'ZTFI_0074'
        CHANGE_INDICATOR       = UPD_ZTFI_0074
        DOCU_DELETE            = 'X'
        DOCU_INSERT            = 'X'
        DOCU_DELETE_IF         = ''
        DOCU_INSERT_IF         = ''
      TABLES
        TABLE_OLD              = YZTFI_0074
        TABLE_NEW              = XZTFI_0074
      EXCEPTIONS
        NAMETAB_ERROR          = 1
        OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTFI_0074 NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTFI_0074
       EXCEPTIONS
         OPEN_MISSING           = 1
