...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFI_0075
*   generation date: 07.12.2018 at 19:41:15
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFI_0075'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFI_0075_EXTRACT
TOTAL = ZVFI_0075_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFI_0075'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFI_0075-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_0075_EXTRACT
TOTAL = ZVFI_0075_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFI_0075-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFI_0075'
...
TOTAL = ZVFI_0075_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFI_0075-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFI_0075-UPD_FLAG NE SPACE.
