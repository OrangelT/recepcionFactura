...
public section.
  ...
  data:
    fechasii TYPE STANDARD TABLE OF t_fechasii .
  data:
...
*        SELECT * FROM zcds_0074u( p_dia = @sy-datum , p_totdias = @me->dias )"NVSACC 021024 CAMBIADA POR DDL ENTIDAD
    SELECT * FROM zDDL_P_0074U( p_dia = @sy-datum , P_TOTDIAS = @me->dias )"NVSACC 021024 CAMBIADA POR DDL ENTIDAD
