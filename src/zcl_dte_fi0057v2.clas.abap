CLASS zcl_dte_fi0057v2 DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA fecha_e_aem TYPE datum .
    ...
    DATA:
*    lt_factmm TYPE STANDARD TABLE OF zcds_factmm ."nvsacc 031024
      lt_factmm TYPE STANDARD TABLE OF zddl_i_factmm . "nvsacc 031024
*  data WA_FACTMM type ZCDS_FACTMM ."nvsacc 031024
    DATA wa_factmm TYPE zddl_i_factmm .  "nvsacc 031024
    ...
    DATA lt_ztfi_0096 TYPE STANDARD TABLE OF ztfi_0096 .
    DATA ls_0096 TYPE ztfi_0096 .
...
*      WHERE vatint EQ gs_varint.
      ...
      IF sy-subrc EQ 0.
      ENDIF.
       "----> busco tabla de proveedores excluidos
      SELECT * INTO TABLE lt_ztfi_0096
      FROM ztfi_0096
      WHERE bukrs IN s_bukrs.
    ENDIF.
  ENDIF.
...
*        SELECT * INTO wa_factmm FROM zcds_factmm UP TO 1 ROWS "nvsacc 031024
      SELECT * INTO @wa_factmm FROM zddl_i_factmm UP TO 1 ROWS "nvsacc 031024
        WHERE bukrs = @<lt2>-bukrs AND
              xblnr = @<lt2>-folioref AND
              lifnr = @<lt2>-lifnr AND
              tipodte = @<lt2>-tiporef
              ORDER BY bukrs . "xblnr. "nvsacc dice q no esta permitido el xblnr
        ENDSELECT.
        IF sy-subrc = 0.
